  ...
  return (
    ...
    <View style={webStyles.webContainer}>
      <View style={webStyles.userLoginContainer}>
        <LoginLayout nav={nav}></LoginLayout>
      </View>
  ...
  return (
    ...
    <View style={loginStyles.container}>
      ...
      <View style={loginStyles.loginContainer}>
        ...
        <TouchableOpacity style={[loginStyles.defaultButton, {backgroundColor: colors.dreamBlue}]} onPress={() => nav('Chat')}>
            <Text style={loginStyles.buttonText}>Entrar</Text>
        </TouchableOpacity>
        <Text style={{marginTop: 10}}> Não possui uma conta? </Text>
        <TouchableOpacity style={[loginStyles.defaultButton, {backgroundColor: '#fff', borderColor: colors.textColor, borderWidth: 1}]} onPress={() => nav('Register')}>
